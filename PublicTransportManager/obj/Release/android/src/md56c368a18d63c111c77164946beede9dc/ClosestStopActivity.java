...
public class ClosestStopActivity
		...
		com.google.android.gms.maps.GoogleMap.InfoWindowAdapter
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PublicTransportManager.ClosestStopActivity, Public Transport Manager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ClosestStopActivity.class, __md_methods);
	}


	public ClosestStopActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ClosestStopActivity.class)
			mono.android.TypeManager.Activate ("PublicTransportManager.ClosestStopActivity, Public Transport Manager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

...
public class CheckLineActivity
		...
		com.google.android.gms.maps.GoogleMap.InfoWindowAdapter
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PublicTransportManager.CheckLineActivity, Public Transport Manager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CheckLineActivity.class, __md_methods);
	}


	public CheckLineActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == CheckLineActivity.class)
			mono.android.TypeManager.Activate ("PublicTransportManager.CheckLineActivity, Public Transport Manager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
